...
This notification fires when a vendor payout has been settled and the funds have been sent to the vendor's delivery method.

### vendor_payout.failed

This notification fires when a vendor payout has failed to settle.
